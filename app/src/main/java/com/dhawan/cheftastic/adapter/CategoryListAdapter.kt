...
class CategoryListAdapter(val context: Context, private val itemList: ArrayList<Category>): RecyclerView.Adapter<CategoryListAdapter.CategoryViewHolder>() {

    class CategoryViewHolder(view: View): RecyclerView.ViewHolder(view){
        val category: TextView = view.findViewById(R.id.txtCategoryList)
        val image: ImageView = view.findViewById(R.id.imgCategoryList)
        val layout: CardView = view.findViewById(R.id.layoutCategory)
    }
